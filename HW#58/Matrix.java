//Stefan Tan
//APCS1 pd8
//HW#58 -- Make the Matrix Work For You
//2017-12-20
...
public class Matrix 
{
	...
	for (int r = 0; r < m3.size(); r++) {
	    for (int c = 0; c < m3.size(); c++) {
		m3._matrix[r][c] = (int)(Math.random()* 10);
	    }
	}

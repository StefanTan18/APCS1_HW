...
~~~~~~~~~~~~~~~~IMPROVEMENTS~~~~~~~~~~~~~~~~~
Now it prints out what the user had chosen to swap.
It nows gives the user a range from which to choose their row and columns.
*/
...
public class Swapper{
	...
	//prints out what the user is swapping for clarity
	System.out.print("\n" + _words[a][b] + " is swapping with " + _words[c][d] + "\n");
	...
	System.out.println("\nSwap:");
	System.out.println("\nPlease choose a row # from 0-2:");
	int s = Keyboard.readInt();
	System.out.println("\nPlease choose a column # from 0-2:");
